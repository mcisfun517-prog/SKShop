...
namespace SKShop
{
    public static class ShopData
    {
        public static SKConfig.SKItem[] GetDefaultShopItems()
        {
            ...
            items.Add(new SKConfig.SKItem() { NetID = 4015,  Prefix = 0, Price = new SKConfig.Price { Copper = 0, Silver = 20, Gold = 0, Platinum = 0 }, Conditions = Array.Empty<string>(), Page = 2, SlotIndex = 20, Note = "汉堡" });
